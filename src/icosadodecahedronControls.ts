...
export default function icosadodecahedronControls(
		DOM: MainDOMSource,
		config: Config,
		...
		const { vdom, props, storage } = createControls('icosadodecahedron', 'Visibility', controlSchema, DOM, storageResponses);
